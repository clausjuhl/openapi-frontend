...
window.addEventListener('load', function () {
  ...
  var subtreeHeaders = document.querySelectorAll('li[role="treeitem"] > span[class="facetItem"]');
  // var stub = `<svg aria-hidden="true" focusable="false" viewBox="0 0 10 10">
  //     <rect class="vert" height="7" width="1" y="1" x="4"/>
  //     <rect height="1" width="7" y="4" x="1"/>
  //     </svg>`

  // var stub = `<svg class="icon" aria-hidden="true" focusable="false"
  ...
  for (var i = 0; i < subtreeHeaders.length; i++) {
    ...
    h.innerHTML += `<svg class="icon" aria-hidden="true" focusable="false"
    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16" width="16" height="16">
    <path fill-rule="evenodd" d="M12.78 6.22a.75.75 0 010 1.06l-4.25 4.25a.75.75 0 01-1.06 0L3.22 7.28a.75.75 0 011.06-1.06L8 9.94l3.72-3.72a.75.75 0 011.06 0z"></path>
    </svg>`;
  }
