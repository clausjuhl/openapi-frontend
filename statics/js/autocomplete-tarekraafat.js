    ...
    function d(t, e, n, i, o, r) {
      i({
        ...
        selection: o.list.find(function (e) {
          return t.keyCode === f
            ? e.index === Number(r.getAttribute(a))
            : "mousedown" === t.type
            ? e.index === Number(t.currentTarget.getAttribute(a))
            : void 0;
        }),
      }),
        s(n);
    ...
    return (function () {
      function K(e) {
        ...
        (this.selector = n),
          ...
          (this.query = l),
          (this.trigger = { event: d, condition: f }),
          (this.searchEngine =
            "loose" === m ? "loose" : "function" == typeof m ? m : "strict"),
          (this.threshold = g),
          (this.debounce = b),
          (this.resultsList = { render: C, view: J, navigation: H }),
          (this.sort = P),
          (this.placeHolder = I),
          (this.maxResults = N),
          (this.resultItem = { content: W, element: F }),
          (this.noResults = O),
          (this.highlight = B),
          (this.onSelection = G),
          this.init();
        ...
        (function (e, t, n) {
                    ...
                    if (t) {
                      var n =
                        "function" == typeof u.searchEngine
                          ? u.searchEngine(u.queryValue, t)
                          : u.search(u.queryValue, t);
                      n && e
                        ? l.push({ key: e, index: o, match: n, value: i })
                        : n && !e && l.push({ index: o, match: n, value: i });
                    }
                  }
                  if (u.data.key) {
                    var t = !0,
                    ...
                    try {
                      for (
                        var s, a = u.data.key[Symbol.iterator]();
                        !(t = (s = a.next()).done);
                        t = !0
                      ) {
                        e(s.value);
          ...
          },
          {
            ...
            value: function () {
              ...
              function t(t) {
                Promise.resolve(
                  a.data.cache ? a.dataStream : a.data.src()
                ).then(function (e) {
                  (a.dataStream = e),
                    (function (t) {
                      function n(e, t) {
                        l.dispatchEvent(
                          new y.CustomEventWrapper("autoComplete", {
                            bubbles: !0,
                            detail: {
                              event: e,
                              input: i,
                      ...
                      var i =
                        ...
                        o = (a.queryValue =
                          a.query && a.query.manipulate
                            ? a.query.manipulate(i)
                            : i),
                        e = a.resultsList.render,
                        r = a.trigger.condition
                          ? a.trigger.condition(o)
                          : o.length > a.threshold &&
                            o.replace(/ /g, "").length;
                      if (e) {
                        ...
                        r
                          ? a
                              .listMatchedResults(a.dataStream, t)
                              .then(function (e) {
                                n(t, e),
                                  a.resultsList.render &&
                                    (0 === e.list.length && a.noResults
                                      ? a.noResults()
                                      : (c(s, e.list, a.resultItem),
                                        a.onSelection &&
                                          (a.resultsList.navigation
                                            ? a.resultsList.navigation(
                                                t,
                                                l,
                                                s,
